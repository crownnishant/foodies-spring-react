...
const Menubar = () => {
  ...
  const logout=()=> {
    ...
    setToken("");
    setQuantities({});   // <-- clear cart in memory
    navigate("/");
  ...
  <div className="container">
    <Link to ="/"> <img src={assets.logo} alt=""  className='mx-4' height={55} width={85}/></Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="d-flex align-items-center gap-4">
        ...
        <button className='btn btn-outline-success btn-sm' onClick={() => navigate('/register')}>Register</button>
                ...
                <a href='' className='d-block link-body-emphasis text-decoration-none drodown-toggle' data-bs-toggle="dropdown" aria-expanded="false">
                <img src={assets.profilepic} alt=""  width={32} height={32} className='rounded-circle'/>
                </a>
